...
<style scoped>
.au-gallery {
    background: radial-gradient(circle at top, #020617 0, #020617 65%, #000);
    color: #e5e7eb;
    padding: 52px 0 60px;
}
...
.au-gallery__item:hover {
    ...
    box-shadow: 0 26px 80px rgba(59, 130, 246, 0.55);
}

.au-gallery__overlay {
    position: absolute;
    inset: 0;
    background: linear-gradient(to top, rgba(15, 23, 42, 0.95), rgba(15, 23, 42, 0.1) 55%);
    display: flex;
